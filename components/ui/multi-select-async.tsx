...
interface Props extends React.ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  /**
   * Custom label function for rendering options in the dropdown.
   * Optional, defaults to null.
   */
  labelFunc?: (
    option: Option,
  ...
  /**
   * Custom label function for rendering selected values in badges.
   * If not provided, falls back to option.label.
   * Optional, defaults to null.
   */
  badgeLabelFunc?: (option: Option) => React.ReactNode;
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-1 truncate text-xs max-w-[100px] ">
                          {option && badgeLabelFunc
                            ? badgeLabelFunc(option)
                            : option?.label}
                        </div>
                        <X
